...
<script>
	...
	function excelDownload(){
		...
		form.action = "downloadExcelHistRegData";
		form.method = "POST";
	...
	function search(initload){
		var url='loadServerSideHistRegData?';
		var facompanygroup=$("select#companyGroup").val();	
		var facompany=$("select#companyName").val();		
		var taxInstallDateFrom=$("#datepicker").val();
		var taxInstallDateTo=$("#datepicker1").val();
				...
				<div class="col-lg-12  col-sm-12 ">
					<div class="accordion" id="Selection">
						<div class="col-lg-6  col-sm-6 " style="margin-left: 40%;">
							...
							<b >Legacy Federal Tax Asset Register</b>
						</div>
							...
							<div id="Selectiontab">
								...
								<div id="taxRegReport col-lg-12  col-sm-12 " style="width: 1450px;">
									<div class="row" style="margin-left: 1px;">
										...
										<div class=" col-lg-2 col-sm-2 " style="margin-left: 4px;">Year</div>
										<div class=" col-lg-2 col-sm-2 " style="margin-left: -100px;">Report Name</div>
										<div class=" col-lg-2 col-sm-2 " style="margin-left: -85px;">Business Group</div>
										<div class=" col-lg-2 col-sm-2 " style="margin-left: -98px;">Company Code</div>
										<!-- 13sep -->
										<div class="col-lg-4 col-sm-4 " style="margin-top: 3px;margin-left: -70px;">Tax Install Date From -  Tax Install Date To</div>
										<!-- 13sep -->
...
<%-- 													<option >${item}</option> --%>
	...
	<!-- <div style="width: 80%"> -->
		...
		<thead>
			...
			Tax Section 1245_1250 Property<br></td>
			...
			Listed Property<br></td>
			<td class="resultsHeader sorting" tabindex="0" aria-controls="tickettable" rowspan="1" colspan="1" aria-label="Corp Book Accum Reserve: activate to sort column ascending" style="width: 41px;">
			Depr Intanible<br></td>
			<td class="resultsHeader sorting" tabindex="0" aria-controls="tickettable" rowspan="1" colspan="1" aria-label="Corp Book Current Depr: activate to sort column ascending" style="width: 37px;">
			First Depr Year<br>
			</td><td class="resultsHeader sorting" tabindex="0" aria-controls="tickettable" rowspan="1" colspan="1" aria-label="Corp Last Year Depreciated: activate to sort column ascending" style="width: 59px;">
			Corp Internal Asset<br></td>
			<td class="resultsHeader sorting" tabindex="0" aria-controls="tickettable" rowspan="1" colspan="1" aria-label="Corp Last Month Depreciated: activate to sort column ascending" style="width: 59px;">
			Tax Amt Table<br></td>
			<td class="resultsHeader sorting" tabindex="0" aria-controls="tickettable" rowspan="1" colspan="1" aria-label="Corp NBV: activate to sort column ascending" style="width: 24px;">
			Tax New or Used<br></td>
			<td class="resultsHeader sorting" tabindex="0" aria-controls="tickettable" rowspan="1" colspan="1" aria-label="Corp Fully Retired: activate to sort column ascending" style="width: 36px;">
			Tax Auto<br></td>			
			<td class="resultsHeader sorting" tabindex="0" aria-controls="tickettable" rowspan="1" colspan="1" aria-label="Corp Fully Retired: activate to sort column ascending" style="width: 36px;">
			Tax LeaseHold Impr<br></td>			
			<td class="resultsHeader sorting" tabindex="0" aria-controls="tickettable" rowspan="1" colspan="1" aria-label="Corp Fully Retired: activate to sort column ascending" style="width: 36px;">
			Tax Depr Method<br></td>			
			<td class="resultsHeader sorting" tabindex="0" aria-controls="tickettable" rowspan="1" colspan="1" aria-label="Corp Fully Retired: activate to sort column ascending" style="width: 36px;">
			 Tax Depr Convention<br></td>			
			<td class="resultsHeader sorting" tabindex="0" aria-controls="tickettable" rowspan="1" colspan="1" aria-label="Corp Fully Retired: activate to sort column ascending" style="width: 36px;">
			Corp Install Date<br></td>			
			<td class="resultsHeader sorting" tabindex="0" aria-controls="tickettable" rowspan="1" colspan="1" aria-label="Corp Fully Retired: activate to sort column ascending" style="width: 36px;">
			Corp Asset Life<br></td>			
			<td class="resultsHeader sorting" tabindex="0" aria-controls="tickettable" rowspan="1" colspan="1" aria-label="Corp Fully Retired: activate to sort column ascending" style="width: 36px;">
			Corp Book Cost Basis<br></td>			
			<td class="resultsHeader sorting" tabindex="0" aria-controls="tickettable" rowspan="1" colspan="1" aria-label="Corp Fully Retired: activate to sort column ascending" style="width: 36px;">
			Corp Book Acum Reserve<br></td>			
			<td class="resultsHeader sorting" tabindex="0" aria-controls="tickettable" rowspan="1" colspan="1" aria-label="Corp Fully Retired: activate to sort column ascending" style="width: 36px;">
			Corp Book Current Year<br></td>			
			<td class="resultsHeader sorting" tabindex="0" aria-controls="tickettable" rowspan="1" colspan="1" aria-label="Corp Fully Retired: activate to sort column ascending" style="width: 36px;">
			Corp Last Year Depreciated<br></td>			
			<td class="resultsHeader sorting" tabindex="0" aria-controls="tickettable" rowspan="1" colspan="1" aria-label="Corp Fully Retired: activate to sort column ascending" style="width: 36px;">
			Corp Last Month Depreciated<br></td>			
			<td class="resultsHeader sorting" tabindex="0" aria-controls="tickettable" rowspan="1" colspan="1" aria-label="Corp Fully Retired: activate to sort column ascending" style="width: 36px;">
			Corp NBV<br></td>			
			<td class="resultsHeader sorting" tabindex="0" aria-controls="tickettable" rowspan="1" colspan="1" aria-label="Corp Fully Retired: activate to sort column ascending" style="width: 36px;">
			Corp Fully Retired<br></td>			
			<td class="resultsHeader sorting" tabindex="0" aria-controls="tickettable" rowspan="1" colspan="1" aria-label="Corp Fully Retired: activate to sort column ascending" style="width: 36px;">
			Project<br></td>			
			<td class="resultsHeader sorting" tabindex="0" aria-controls="tickettable" rowspan="1" colspan="1" aria-label="Corp Fully Retired: activate to sort column ascending" style="width: 36px;">
			Category<br></td>
			...
			Category Desc<br></td>			
			<td class="resultsHeader sorting" tabindex="0" aria-controls="tickettable" rowspan="1" colspan="1" aria-label="Corp Fully Retired: activate to sort column ascending" style="width: 36px;">
			Tax Installation Year<br></td>			
			<td class="resultsHeader sorting" tabindex="0" aria-controls="tickettable" rowspan="1" colspan="1" aria-label="Corp Fully Retired: activate to sort column ascending" style="width: 36px;">
			Tax Curr Acc Year<br></td>			
			<td class="resultsHeader sorting" tabindex="0" aria-controls="tickettable" rowspan="1" colspan="1" aria-label="Corp Fully Retired: activate to sort column ascending" style="width: 36px;">
			Instance_1<br></td>			
			<td class="resultsHeader sorting" tabindex="0" aria-controls="tickettable" rowspan="1" colspan="1" aria-label="Corp Fully Retired: activate to sort column ascending" style="width: 36px;">
			Year_1 <br></td>
