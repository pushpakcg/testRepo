...
<html>
  <head>
    ...
    <title>Fixed Assets Reporting System - Custom Menu</title>
    ...
    <link
      rel="StyleSheet"
      href="css/styles_bs/main.css"
      type="text/css"
      media="screen"
    />
    <link
      href="http://www.jqueryscript.net/css/top.css"
      rel="stylesheet"
      type="text/css"
    />
    ...
    <script
      src="https://cdn.syncfusion.com/js/assets/external/jquery.easing.1.3.min.js"
      type="text/javascript"
    ></script>
    <script
      src="https://cdn.syncfusion.com/18.1.0.54/js/web/ej.web.all.min.js"
      type="text/javascript"
    ></script>
    ...
    <script>
      ...
      var localData = [
        { id: 1, name: "FA Income Tax", hasChild: true },
        {
          id: 2,
          pid: 1,
          name: "Tax Asset Register",
          linkAttribute: "/FAWebApp/menu?page=taxAdditionReport",
        },
        {
          id: 3,
          pid: 1,
          name: "Tax Asset Additions Report",
          linkAttribute: "/FAWebApp/menutax?page=taxRegisterReport",
        },
        {
          id: 4,
          pid: 1,
          name: "Tax Asset Retirement Report",
          linkAttribute: "/FAWebApp/menutax?page=taxRetirement",
        },
        ...
        { id: 33, name: "FA Dashboard", hasChild: true, expanded: true },
        {
          id: 34,
          pid: 33,
          name: "FA Asset Dashboard",
          linkAttribute: "/FAWebApp/menudash?page=dashboardReport",
        },
 ...
 */
  ...
  <style type="text/css">
    ...
    .custom.e-treeview .e-icon.e-minus,
    .custom.e-treeview .e-icon.e-plus {
    ...
    <div class="fluid-container header_main">
      <div class="container-fluid">
        <div class="row">
          ...
          <div class="col-lg-4 col-xs-4 logo_main" style="margin-top: 10px">
            <img src="images/Home/logo.png" class="img-responsive" />
          </div>
          <div class="col-lg-3 col-xs-4 faat_logo">
            <img
              src="images/Home/type 2.png"
...
<li><a href="https://login.stg.inbcu.com/login/logoff.jsp"><span class="glyphicon glyphicon-log-out"></span>Logout</a></li>
          ...
          <div
            class="col-lg-1 col-xs-3 user_main"
            style="float: right; margin-top: 8px"
          >
            <a href="/FAWebApp" class="topnav-right"
              ><img
          ...
          <div class="col-lg-2 col-xs-3 user_main" style="float: right">
            ...
            <i
              class="fa fa-user-circle-o user"
              data-toggle="dropdown"
              aria-expanded="false"
              style="margin-top: 7px"
            ></i>
            <!-- <p id="fawebusername" style="margin-top: 13px;font-size: 18px;float:right;"></p> -->
            <p style="margin-top: 13px; font-size: 18px; float: right">
