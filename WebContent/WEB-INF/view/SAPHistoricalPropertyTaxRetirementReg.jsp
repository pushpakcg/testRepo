...
<script>
	$(document).ready(function() {
		...
		$("#excelDownloadButton").click(function(){
		 ...
		 $('#companyGroup').change(function(event) {
			...
			$.getJSON('getSAPHistPropTaxRetirementRegCompanyNames', {
				groupName : groupName
			}, function(data) {
		 ...
		 $('#year').change(function(event) {
				...
				$.getJSON('getSAPHistPropTaxRetirementReportNames', {
		 ...
		 $('#reportName').change(function(event) {
			  ...
			  var urll="getSapHistPropTaxRetHeadings?reportId="+reportId+'&year='+year;
	...
	function excelDownload(){
		...
		form.action = "downloadExcelSAPHistPropTaxRetirementRegData";
		form.method = "POST";
	...
	function search(initload){
		var url='loadServerSideSAPHistPropTaxRetirementRegData?';
		var facompanygroup=$("select#companyGroup").val();	
		var facompany=$("select#companyName").val();		
		var RetirementDateFrom=$("#datepicker").val();
		var RetirementDateTo=$("#datepicker1").val();
				...
				<div class="col-lg-12  col-sm-12 ">
					<div class="accordion" id="Selection">
						<div class="col-lg-6  col-sm-6 " style="margin-left: 40%;">
							...
							<b >SAP Historical Property Tax Retirement Report</b>
						</div>
