...
<script>
	...
	var localData = [
		{ id: 1, name: "SAP Production Reports", hasChild: true, expanded: false },
        ...
        { id: 8, pid: 1, name: "State Tax Asset Listing",linkAttribute: "/FAWebApp/menutax?page=StateTaxReg" },
	       ...
	       // { id: 14, pid: 9, name: "Federal Tax Asset Register â Revision using Q3 2022" },
	        ...
	        { id: 21, name: "Infinium Historical Reports", hasChild: true, expanded: false},
	        ...
	        { id: 26, name: "Admin Functions", hasChild: true, expanded: false},
