...
<script>
	...
	$(document).ready(function() {
		...
		$("#excelDownloadButton").click(function(){
		 ...
		 $('#companyGroup').change(function(event) {
			...
			$.getJSON('getSAPHistStateTaxCompanyNames', {
				groupName : groupName
			}, function(data) {
		 ...
		 $('#year').change(function(event) {
				...
				$.getJSON('getSAPHistStateTaxReportNames', {
		 ...
		 $('#reportName').change(function(event) {
			  ...
			  var urll="getSapHistStateTaxHeadings?reportId="+reportId+'&year='+year;
	...
	function excelDownload(){
		...
		form.action = "SAPHistStateTaxdownloadExcelData";
		form.method = "POST";
		...
		var data={facompanygroup:escape(facompanygroup),facompany:escape(facompany),taxInstallDateFrom:escape(taxInstallDateFrom),taxInstallDateTo:escape(taxInstallDateTo)
				,year:escape(year),reportId:escape(reportId),stategroup:escape(stategroup),excelDownloadFlow:'true'};
		if (data) {
		for ( var key in data) {
	...
	function search(initload){
		var url='loadSAPHistStateTaxserverSideData?';
		var facompanygroup=$("select#companyGroup").val();
		var facompany=$("select#companyName").val();
		var taxInstallDateFrom=$("#datepicker").val();
		var taxInstallDateTo=$("#datepicker1").val();
		...
		if (initload == "yes") {
			...
			+'&year='+year+'&reportId='+reportId+'&stategroup='+stategroup;
		}
				...
				<div class="col-lg-12  col-sm-12 ">
					<div class="accordion" id="Selection">
						<div class="col-lg-6  col-sm-6 " style="margin-left: 40%;">
							...
							<b >SAP Hist State Tax Asset Listing</b>
						</div>
							...
							<div id="Selectiontab">
								...
								<div id="taxRegReport col-lg-12  col-sm-12 " style="width: 1450px;">
									<div class="row" style="margin-left: 1px;">
										...
										<div class="col-lg-2 col-sm-2 " style="margin-left: -118px;">State</div>
									</div>
...
<!-- 													<option >${item}</option> -->
										...
										<div class="form-group col-lg-2 col-sm-2 " style="margin-left: -150px;">
											...
											<select class="form-control" name="companyGroup" id="companyGroup" style="font-family: Calibri; font-size: 11px; width:135px">
										...
										<!-- <div class="form-group col-lg-2 col-sm-2 "> -->
										<div class="form-group col-lg-2 col-sm-2 " style="margin-left: -61px;">
										<select class="form-control" name="companyName" id="companyName" style="font-family: Calibri; font-size: 12px; width: 155px;margin-left: -11%;">
										...
										<div class="form-group col-lg-2 col-sm-2 " style="margin-left: -102px;">

										<div class="form-control "style="width: 64%; padding: 4px 12px;">
										...
										<div class="form-group col-lg-1 col-sm-1 " style="margin-left: -40px;">
										<!-- <button id="searchbutton">Searchbutton</button> -->
										<!-- <div class="form-group col-lg-1 col-sm-1 "> -->
										<a id="searchbutton" href="#" class="btn btn-info btn-md" data-toggle="tooltip" data-placement="right" title="Excute" style="margin-left: 50%;"> <span class="glyphicon glyphicon-play" id="executeBtn" style="font-size: 100%;margin-top: 3%;"></span>
											</a>
											</div>
	...
	<div class="tableDiv" style="margin-top: 4px;margin-left:5px;margin-right:5px;overflow-x:scroll" >
		<table id="myDatatable" class="table table-striped table-bordered dataTable no-footer" role="grid" aria-describedby="tickettable_info" style="width: 3971px;font-size: 12px;text-align: center;margin-left:0px"> 
