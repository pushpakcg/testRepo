...
<script>
	...
	var localData = [
        ...
        { id: 4, pid: 1, name: "Federal Tax ADS Asset Register" },
        { id: 5, pid: 1, name: "ADS Tax Asset Register"},
        { id: 6, pid: 1, name: "Property Tax Asset Register",linkAttribute: "/FAWebApp/proptax?page=PropTaxReg"},
        { id: 7, pid: 1, name: "Property Tax Asset Retirement Report",linkAttribute: "/FAWebApp/proptax?page=PropTaxRetirement"},
        //{ id: 8, pid: 1, name: "Property Tax Physical Location listing" },
		   { id: 8, pid: 1, name: "State Tax Asset Listing",linkAttribute: "/FAWebApp/StateTaxReg?page=StateTaxReg" },
		   { id: 9, name: "SAP Historical Reports", hasChild: true},
		   { id: 10, pid: 9, name: "2021"},
		   { id: 11, pid: 10, name: "Federal Tax Asset Register" },
		   { id: 12, pid: 10, name: "Federal Tax Asset Retirement Report" },
		   { id: 13, pid: 10, name: "Federal Tax ADS Asset Register" },
		   { id: 14, pid: 10, name: "Property Tax Asset Register" },
	        { id: 15, pid: 10, name: "Property Tax Asset Retirement Report" },
	        { id: 16, pid: 10, name: "Property Tax Physical Location listing" },
	        { id: 17, pid: 10, name: "State Tax Asset Listing" },
	        { id: 18, pid: 9, name: "2022"},
	        { id: 19, pid: 9, name: "2023"},
	        { id: 20, name: "Infinium Historical Reports", hasChild: true},
	        { id: 21, pid: 20, name: "Federal Tax Asset Register"},
	        { id: 22, pid: 20, name: "Federal Tax Asset Retirement Report"},
	        { id: 23, pid: 20, name: "Federal Tax ADS report"}
