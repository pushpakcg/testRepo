...
//var globalVar;
	$(document).ready(function() {
		...
		$("#excelDownloadButton").click(function(){
		 ...
		 $('#companyGroup').change(function(event) {
			...
			$.getJSON('getStateIncomeTaxCompanyNames', {
				groupName : groupName
			}, function(data) {
		 ...
		 function headings()
		 {
			 var url="getStateIncomeTaxHeadings";
	...
	function assetTrans2excelDownload(){
		...
		form.action = "StateIncomeTaxdownloadExcelData";
		form.method = "POST";
...
// 		var proptaxCreateDateTo=$("#datepicker3").val();
		...
		var data={facompanygroup:escape(assetTranscompanygroup),facompany:escape(assetTranscompany),taxInstallDateFrom:escape(assetTransChangeDateFrom),taxInstallDateTo:escape(assetTransChangeDateTo)
	...
	function search(initload){
		var url='loadStateIncomeTaxserverSideData?';
...
// 		var proptaxCreateDateTo=$("#datepicker3").val();
		...
		if (initload == "yes") {
			...
			url=url+'&facompanygroup='+assetTranscompanygroup+'&facompany='+assetTranscompany+'&taxInstallDateFrom='+assetTransChangeDateFrom+'&taxInstallDateTo='+assetTransChangeDateTo;
							...
							<div id="Selectiontab">
								...
								<div id="taxRegReport col-lg-12  col-sm-12 " style="width: 1340px;">
									<div class="row" style="margin-left: 1px;">
										...
										<!-- 13sep -->
										<div class="col-lg-4 col-sm-4 " style="margin-left: -2%;">Install Date From -  Install Date  To</div>
										<!-- 13sep -->
