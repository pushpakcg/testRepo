							...
							<div id="Selectiontab">
								...
								<div id="taxRegReport col-lg-12  col-sm-12 " style="width: 1340px;">
									<div class="row" style="margin-left: 1px;">
										...
										<div class=" col-lg-4 col-sm-4 " style="margin-top: 3px;margin-left: 13px;">Business Group</div>
										<div class=" col-lg-4 col-sm-4 " style="margin-top: 3px;margin-left: -196px;">Company Code</div>
										<!-- 13sep -->
										<div class="col-lg-4 col-sm-4 " style="margin-top: 3px;margin-left: -15%;">Installation Date From</div>
										<!-- 13sep -->
										...
										<div class="col-lg-4 col-sm-4 " style="margin-left: -211px; margin-top: 3px;">Installation Date To</div>
