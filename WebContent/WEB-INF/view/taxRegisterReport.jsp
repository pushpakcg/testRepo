				...
				<div class="col-lg-12  col-sm-12 ">
					<div class="accordion" id="Selection">
						<div class="col-lg-6  col-sm-6 " style="margin-left: 40%;">
							...
							<b >Tax Asset Additions Report</b>
						</div>
							...
							<div id="Selectiontab">
								...
								<div id="taxRegReport col-lg-12  col-sm-12 " style="width: 1340px;">
									<div class="row" style="margin-left: 1px;">
										...
										<div class=" col-lg-4 col-sm-4 " style="margin-top: 3px;margin-left: 13px;">Company Group</div>
										<div class=" col-lg-4 col-sm-4 " style="margin-top: 3px;margin-left: -196px;">Company Name</div>
										<!-- 13sep -->
										<div class="col-lg-4 col-sm-4 " style="margin-top: 3px;margin-left: -15%;">From Date</div>
										<!-- 13sep -->
										...
										<div class="col-lg-4 col-sm-4 " style="margin-left: -211px; margin-top: 3px;">To Date</div>
