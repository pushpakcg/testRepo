...
<script>
	$(document).ready(function() {
		...
		$("#excelDownloadButton").click(function(){
		 ...
		 $('#companyGroup').change(function(event) {
			...
			$.getJSON('getSAPHistoricalAssetTransferCompanyNames', {
				groupName : groupName
			}, function(data) {
		 ...
		 $('#year').change(function(event) {
				...
				$.getJSON('getSAPHistoricalAssetTransferReportNames', {
		 ...
		 $('#reportName').change(function(event) {
			  ...
			  var urll="getSapHistAssetTransferHeadings?reportId="+reportId+'&year='+year;
	...
	function excelDownload(){
		...
		form.action = "SAPHistAssetTransferdownloadExcelData";
		form.method = "POST";
	...
	function search(initload){
		var url='loadSAPHistAssetTransferserverSideData?';
		var facompanygroup=$("select#companyGroup").val();	
		var facompany=$("select#companyName").val();		
		var taxInstallDateFrom=$("#datepicker").val();
		var taxInstallDateTo=$("#datepicker1").val();
				...
				<div class="col-lg-12  col-sm-12 ">
					<div class="accordion" id="Selection">
						<div class="col-lg-6  col-sm-6 " style="margin-left: 40%;">
							...
							<b >SAP Historical Asset Transfer Report Physical_Location</b>
						</div>
							...
							<div id="Selectiontab">
								...
								<div id="taxRegReport col-lg-12  col-sm-12 " style="width: 1450px;">
									<div class="row" style="margin-left: 1px;">
										...
										<!-- 13sep -->
										<div class="col-lg-4 col-sm-4 " style="margin-top: 3px;margin-left: -70px;">Change Date From -  Change Date  To</div>
										<!-- 13sep -->
