	...
	var localData = [
       ...
       // {id: 33, pid: 1, name: "State Income Tax Report",linkAttribute: "/FAWebApp/menutax?page=StateIncomeTax" },
        {id: 34, pid: 1, name: "Asset Register Summary Report",linkAttribute: "/FAWebApp/menutax?page=AssetRegisterSummaryReport" },
		   ...
		   { id: 14, pid: 9, name: "Property Tax Asset Register",linkAttribute: "/FAWebApp/menutax?page=SAPhistoricalPropertytaxreg" },
	        { id: 15, pid: 9, name: "Property Tax Asset Retirement Report" ,linkAttribute: "/FAWebApp/menutax?page=SAPHistoricalPropertyTaxRetirementReg" },
	        { id: 16, pid: 9, name: "Federal Tax Projection Report" ,linkAttribute: "/FAWebApp/menutax?page=SAPHistoricalProjectionReg"},
	        { id: 17, pid: 9, name: "State Tax Asset Listing" ,linkAttribute: "/FAWebApp/menutax?page=SAPHistStateTax"},
	        {id: 18, pid: 9, name: "Asset Transfer Report Physical_Location" ,linkAttribute: "/FAWebApp/menutax?page=SAPHistAssetTransfer" },
	        {id: 19, pid: 9, name: "Asset Transfer All Transactions" ,linkAttribute: "/FAWebApp/menutax?page=SAPHistAssetTransferAllTrans" },
	        { id: 20, name: "Infinium Historical Reports", hasChild: true, expanded: true},
	        { id: 21, pid: 20, name: "Federal Tax Asset Register",linkAttribute: "/FAWebApp/menutax?page=HistoricalTaxReg" },
	        { id: 22, pid: 20, name: "Federal Tax Asset Retirement Report",linkAttribute: "/FAWebApp/menutax?page=HistoricalTaxRet" },
	        { id: 23, pid: 20, name: "Property Tax Asset Register",linkAttribute: "/FAWebApp/menutax?page=HistoricalPropertyTaxReg" },
	        { id: 24, pid: 20, name: "Property Tax Asset Retirement Report",linkAttribute: "/FAWebApp/menutax?page=HistoricalPropertyTaxRetirementReg" },
	         //{id: 27, pid: 21, name: "Federal Tax ADS Report Upload",linkAttribute: "/FAWebApp/menutax?page=uploadFile"}
	        { id: 25, name: "Admin Functions", hasChild: true, expanded: true},
	        { id: 26, pid: 25, name: "Report Amendment",linkAttribute: "/FAWebApp/menutax?page=uploadFile" },
			{ id: 28, pid: 25, name: "Report Archiving",linkAttribute: "/FAWebApp/menutax?page=UploadSapData" },
	        { id: 29, pid: 25, name: "FMV Dashboard",linkAttribute: "/FAWebApp/menutax?page=FMVDashboard" },
	        { id: 30, pid: 25, name: "Asset Transfer",linkAttribute: "/FAWebApp/menutax?page=AssetTransfer"},
	        { id: 31, pid: 25, name: "Tax Only Asset",linkAttribute: "/FAWebApp/menutax?page=taxOnlyAsset" }
...
<div class="fluid-container header_main"><div class="container-fluid"><div class="row"><div class="col-lg-1 col-xs-1" style="margin-top:5px;"><button type="button" id="sidebarCollapse" class="navbar-btn"><a id="nav-toggle" href="#"><span></span></a></button></div><div class="col-lg-4 col-xs-4 logo_main" style="margin-top:10px;"><img src="images/Home/logo.png" class="img-responsive"></div>
