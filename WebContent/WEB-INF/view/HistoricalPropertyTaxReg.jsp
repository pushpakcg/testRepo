...
<script>
	$(document).ready(function() {
		...
		$("#excelDownloadButton").click(function(){
		 ...
		 $('#companyGroup').change(function(event) {
			...
			$.getJSON('getHistPropTaxRegCompanyNames', {
				groupName : groupName
			}, function(data) {
		 ...
		 $('#year').change(function(event) {
				...
				$.getJSON('getHistPropTaxReportNames', {
	...
	function excelDownload(){
		...
		form.action = "downloadExcelHistPropTaxRegData";
		form.method = "POST";
	...
	function search(initload){
		var url='loadServerSideHistPropTaxRegData?';
		var facompanygroup=$("select#companyGroup").val();	
		var facompany=$("select#companyName").val();		
		var taxInstallDateFrom=$("#datepicker").val();
		var taxInstallDateTo=$("#datepicker1").val();
				...
				<div class="col-lg-12  col-sm-12 ">
					<div class="accordion" id="Selection">
						<div class="col-lg-6  col-sm-6 " style="margin-left: 40%;">
							...
							<b >Legacy Property Tax Asset Register</b>
						</div>
...
<!-- 													<option >${item}</option> -->
	...
	<!-- <div style="width: 80%"> -->
		...
		<thead>
			...
			Last Yr Depreciated<br></td>			
			<td class="resultsHeader sorting" tabindex="0" aria-controls="tickettable" rowspan="1" colspan="1" aria-label="Project#: activate to sort column ascending" style="width: 40px;">
			Last Mth Depreciated<br></td>
			<td class="resultsHeader sorting" tabindex="0" aria-controls="tickettable" rowspan="1" colspan="1" aria-label="Project#: activate to sort column ascending" style="width: 40px;">
			Total Retirement Cost<br></td>
			<td class="resultsHeader sorting" tabindex="0" aria-controls="tickettable" rowspan="1" colspan="1" aria-label="Project#: activate to sort column ascending" style="width: 40px;">
			Fully Retired<br></td>
			<td class="resultsHeader sorting" tabindex="0" aria-controls="tickettable" rowspan="1" colspan="1" aria-label="Project#: activate to sort column ascending" style="width: 40px;">
			Accounting Year<br></td>
			<td class="resultsHeader sorting" tabindex="0" aria-controls="tickettable" rowspan="1" colspan="1" aria-label="Project#: activate to sort column ascending" style="width: 40px;">
			Accounting Period<br></td>
			<td class="resultsHeader sorting" tabindex="0" aria-controls="tickettable" rowspan="1" colspan="1" aria-label="Project#: activate to sort column ascending" style="width: 40px;">
			Tax Install Date<br></td>
			<td class="resultsHeader sorting" tabindex="0" aria-controls="tickettable" rowspan="1" colspan="1" aria-label="Project#: activate to sort column ascending" style="width: 40px;">
			Tax Cost Basis<br></td>
			<td class="resultsHeader sorting" tabindex="0" aria-controls="tickettable" rowspan="1" colspan="1" aria-label="Project#: activate to sort column ascending" style="width: 40px;">
			Depr Expense Acct<br></td>
			<td class="resultsHeader sorting" tabindex="0" aria-controls="tickettable" rowspan="1" colspan="1" aria-label="Project#: activate to sort column ascending" style="width: 40px;">
			Asset Acct<br></td>
			<td class="resultsHeader sorting" tabindex="0" aria-controls="tickettable" rowspan="1" colspan="1" aria-label="Project#: activate to sort column ascending" style="width: 40px;">
			Accm Reserve Acct<br></td>
			<td class="resultsHeader sorting" tabindex="0" aria-controls="tickettable" rowspan="1" colspan="1" aria-label="Project#: activate to sort column ascending" style="width: 40px;">
			Purchases Acct<br></td>
			<td class="resultsHeader sorting" tabindex="0" aria-controls="tickettable" rowspan="1" colspan="1" aria-label="Project#: activate to sort column ascending" style="width: 40px;">
			Net Proceeds Acct<br></td>
			<td class="resultsHeader sorting" tabindex="0" aria-controls="tickettable" rowspan="1" colspan="1" aria-label="Project#: activate to sort column ascending" style="width: 40px;">
			Ord Gain/Loss Acct<br></td>
			<td class="resultsHeader sorting" tabindex="0" aria-controls="tickettable" rowspan="1" colspan="1" aria-label="Project#: activate to sort column ascending" style="width: 40px;">
			Extraord Gl Acct<br></td>
			<td class="resultsHeader sorting" tabindex="0" aria-controls="tickettable" rowspan="1" colspan="1" aria-label="Project#: activate to sort column ascending" style="width: 40px;">
			Transfers In Acct<br></td>
			<td class="resultsHeader sorting" tabindex="0" aria-controls="tickettable" rowspan="1" colspan="1" aria-label="Project#: activate to sort column ascending" style="width: 40px;">
			Transfers Out Acct<br></td>
			<td class="resultsHeader sorting" tabindex="0" aria-controls="tickettable" rowspan="1" colspan="1" aria-label="Project#: activate to sort column ascending" style="width: 40px;">
			Trnsr Acct For Asset<br></td>
			<td class="resultsHeader sorting" tabindex="0" aria-controls="tickettable" rowspan="1" colspan="1" aria-label="Project#: activate to sort column ascending" style="width: 40px;">
			Trnsr Acct For AD<br></td>
			<td class="resultsHeader sorting" tabindex="0" aria-controls="tickettable" rowspan="1" colspan="1" aria-label="Project#: activate to sort column ascending" style="width: 40px;">
			Ret Acct For Asset<br></td>
			<td class="resultsHeader sorting" tabindex="0" aria-controls="tickettable" rowspan="1" colspan="1" aria-label="Project#: activate to sort column ascending" style="width: 40px;">
			Ret Acct For AD<br></td>
			<td class="resultsHeader sorting" tabindex="0" aria-controls="tickettable" rowspan="1" colspan="1" aria-label="Project#: activate to sort column ascending" style="width: 40px;">
			Quantity<br></td>
			<td class="resultsHeader sorting" tabindex="0" aria-controls="tickettable" rowspan="1" colspan="1" aria-label="Project#: activate to sort column ascending" style="width: 40px;">
			Org Internal Asst No<br></td>
			<td class="resultsHeader sorting" tabindex="0" aria-controls="tickettable" rowspan="1" colspan="1" aria-label="Project#: activate to sort column ascending" style="width: 40px;">
			Org Company<br></td>
			<td class="resultsHeader sorting" tabindex="0" aria-controls="tickettable" rowspan="1" colspan="1" aria-label="Project#: activate to sort column ascending" style="width: 40px;">
			Asset Status<br></td>
			...
			User Feild 13<br></td>
			<td class="resultsHeader sorting" tabindex="0" aria-controls="tickettable" rowspan="1" colspan="1" aria-label="Project#: activate to sort column ascending" style="width: 40px;">
			User Feild 14<br></td></tr>
			
		</thead>
		<tbody>
			
		 <tr class="odd"><td valign="top" colspan="76" class="dataTables_empty"></td></tr></tbody> 
