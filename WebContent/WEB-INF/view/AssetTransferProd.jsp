...
//var globalVar;
	$(document).ready(function() {
		...
		$("#excelDownloadButton").click(function(){
		 ...
		 $('#companyGroup').change(function(event) {
			...
			$.getJSON('getAssetTransferProdCompanyNames', {
				groupName : groupName
			}, function(data) {
		 ...
		 function headings()
		 {
			 var url="getAssetTransferProdHeadings";
	...
	function assetTransexcelDownload(){
		
		var form = document.createElement("form");
		form.action = "AssetTransferProddownloadExcelData";
		form.method = "POST";
...
// 		var proptaxCreateDateTo=$("#datepicker3").val();
	...
	function search(initload){
		var url='loadAssetTransferProdserverSideData?';
				...
				<div class="col-lg-12  col-sm-12 ">
					<div class="accordion" id="Selection">
						<div class="col-lg-6  col-sm-6 " style="margin-left: 40%;">
							...
							<b >Asset Transfer Physical Location Report</b>
						</div>
							...
							<div id="Selectiontab">
								...
								<div id="taxRegReport col-lg-12  col-sm-12 " style="width: 1340px;">
									<div class="row" style="margin-left: 1px;">
										...
										<!-- 13sep -->
										<div class="col-lg-4 col-sm-4 " style="margin-left: -2%;">Change Date From - Change Date To </div>
										<!-- 13sep -->
