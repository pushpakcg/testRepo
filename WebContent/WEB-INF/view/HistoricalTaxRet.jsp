...
<script>
	$(document).ready(function() {
		...
		$("#excelDownloadButton").click(function(){
		 ...
		 $('#companyGroup').change(function(event) {
			...
			$.getJSON('getHistRetCompanyNames', {
				groupName : groupName
			}, function(data) {
	...
	function search(initload){
		var url='loadServerSideHistRetData?';
		var facompanygroup=$("select#companyGroup").val();	
		var facompany=$("select#companyName").val();		
		var taxInstallDateFrom=$("#datepicker").val();
		var taxInstallDateTo=$("#datepicker1").val();
				...
				<div class="col-lg-12  col-sm-12 ">
					<div class="accordion" id="Selection">
						<div class="col-lg-6  col-sm-6 " style="margin-left: 40%;">
							...
							<b >Legacy Federal Tax Asset Retirement</b>
						</div>
...
<!-- 										</div> -->
	...
	<!-- <div style="width: 80%"> -->
		...
		<thead>
			...
			Book Name<br></td>			
			<td class="resultsHeader sorting" tabindex="0" aria-controls="tickettable" rowspan="1" colspan="1" aria-label="Corp Fully Retired: activate to sort column ascending" style="width: 36px;">
			Retirement Code<br></td>			
			<td class="resultsHeader sorting" tabindex="0" aria-controls="tickettable" rowspan="1" colspan="1" aria-label="Corp Fully Retired: activate to sort column ascending" style="width: 36px;">
			Retirement Date<br></td>			
			<td class="resultsHeader sorting" tabindex="0" aria-controls="tickettable" rowspan="1" colspan="1" aria-label="Corp Fully Retired: activate to sort column ascending" style="width: 36px;">
			Retirement Cost<br></td>
			<td class="resultsHeader sorting" tabindex="0" aria-controls="tickettable" rowspan="1" colspan="1" aria-label="Corp Fully Retired: activate to sort column ascending" style="width: 36px;">
			Retirement Proceeds<br></td>			
			<td class="resultsHeader sorting" tabindex="0" aria-controls="tickettable" rowspan="1" colspan="1" aria-label="Corp Fully Retired: activate to sort column ascending" style="width: 36px;">
			Gain/Loss Amt<br></td>			
			<td class="resultsHeader sorting" tabindex="0" aria-controls="tickettable" rowspan="1" colspan="1" aria-label="Corp Fully Retired: activate to sort column ascending" style="width: 36px;">
			Retirement Desc<br></td>	
			<td class="resultsHeader sorting" tabindex="0" aria-controls="tickettable" rowspan="1" colspan="1" aria-label="Corp Fully Retired: activate to sort column ascending" style="width: 36px;">
			Retirement AD<br></td>			
			<td class="resultsHeader sorting" tabindex="0" aria-controls="tickettable" rowspan="1" colspan="1" aria-label="Corp Fully Retired: activate to sort column ascending" style="width: 36px;">
			Retirement YTD<br></td>
			<td class="resultsHeader sorting" tabindex="0" aria-controls="tickettable" rowspan="1" colspan="1" aria-label="Corp Fully Retired: activate to sort column ascending" style="width: 36px;">
			Crt Date<br></td>	
			<td class="resultsHeader sorting" tabindex="0" aria-controls="tickettable" rowspan="1" colspan="1" aria-label="Corp Fully Retired: activate to sort column ascending" style="width: 36px;">
			Crt User<br></td>		
