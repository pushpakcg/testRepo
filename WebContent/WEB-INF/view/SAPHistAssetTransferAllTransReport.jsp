...
<script>
	$(document).ready(function() {
		...
		$("#excelDownloadButton").click(function(){
		 ...
		 $('#companyGroup').change(function(event) {
			...
			$.getJSON('getSAPHistoricalAssetTransferAllTransCompanyNames', {
				groupName : groupName
			}, function(data) {
		 ...
		 $('#year').change(function(event) {
				...
				$.getJSON('getSAPHistoricalAssetTransferAllTransReportNames', {
		 ...
		 $('#reportName').change(function(event) {
			  ...
			  var urll="getSapHistAssetTransferAllTransHeadings?reportId="+reportId+'&year='+year;
	...
	function excelDownload(){
		...
		form.action = "SAPHistAssetTransferAllTransdownloadExcelData";
		form.method = "POST";
	...
	function search(initload){
		var url='loadSAPHistAssetTransferAllTransserverSideData?';
		var facompanygroup=$("select#companyGroup").val();	
		var facompany=$("select#companyName").val();		
		var taxInstallDateFrom=$("#datepicker").val();
		var taxInstallDateTo=$("#datepicker1").val();
		...
		var year=$("select#year").val();		
		var reportId=$("select#reportName").val();
		console.log("from: "+taxInstallDateFrom)
		console.log("to: "+taxInstallDateTo)
		if (facompany === "-1") {
			facompany="";
		}
				...
				<div class="col-lg-12  col-sm-12 ">
					<div class="accordion" id="Selection">
						<div class="col-lg-6  col-sm-6 " style="margin-left: 40%;">
							...
							<b >SAP Historical Asset Transfer All Transactions Report</b>
						</div>
							...
							<div id="Selectiontab">
								...
								<div id="taxRegReport col-lg-12  col-sm-12 " style="width: 1450px;">
									<div class="row" style="margin-left: 1px;">
										...
										<!-- 13sep -->
										<div class="col-lg-4 col-sm-4 " style="margin-top: 3px;margin-left: -70px;">Transfer Date From -  Transfer Date  To</div>
										<!-- 13sep -->
...
<!-- 										</div> -->
	...
	<div class="tableDiv" style="margin-top: 4px;margin-left:5px;margin-right:5px;overflow-x:scroll">
		<table id="myDatatable" class="table table-striped table-bordered dataTable no-footer" role="grid" aria-describedby="tickettable_info" style="width: 3971px;font-size: 13px;text-align: center">
