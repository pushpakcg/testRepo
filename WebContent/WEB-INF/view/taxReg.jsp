...
var globalVar;
	$(document).ready(function() {
		...
		$("#excelDownloadButton").click(function(){
		 ...
		 function headings()
		 {
			 var url="getIncomeTaxAssetRegHeadings";
	...
	function excelDownload(){
		...
		var data={facompanygroup:escape(facompanygroup),facompany: escape(facompany),taxInstallDateFrom:escape(taxInstallDateFrom),taxInstallDateTo:escape(taxInstallDateTo)
				,taxCreateDateFrom:escape(taxCreateDateFrom),taxCreateDateTo:escape(taxCreateDateTo),excelDownloadFlow:'true'};
		if (data) {
		for ( var key in data) {
				...
				<div class="col-lg-12  col-sm-12 ">
					<div class="accordion" id="Selection">
						<div class="col-lg-6  col-sm-6 " style="margin-left: 40%;">
							...
							<b >Federal Tax Asset Register</b>
						</div>
							...
							<div id="Selectiontab">
								...
								<div id="taxRegReport col-lg-12  col-sm-12 " style="width: 1340px;">
									<div class="row" style="margin-left: 1px;">
										...
										<!-- 13sep -->
										<div class="col-lg-4 col-sm-4 " style="margin-top: 3px;margin-left: -4%;">Tax Install Date From -  Tax Install Date To</div>
										<!-- 13sep -->
