...
<!-- Client Side XSS starts -->
<script src="https://cdnjs.cloudflare.com/ajax/libs/dompurify/2.3.5/purify.js" integrity="sha512-yxd56A2DWyiUI702P/AfXGOosXYJcoV+er1gwmcgfp9xn0OTLZjCpbBH4sB+gorA40JDsKLzCwfvC1VhDNPXnA==" crossorigin="anonymous" referrerpolicy="no-referrer"></script>
<!-- Client Side XSS ends -->
<script>
	$(document).ready(function() {
		...
		$("#excelDownloadButton").click(function(){
		 ...
		 $('#companyGroup').change(function(event) {
			...
			$.getJSON('getSAPHistoricalProjectionCompanyNames', {
				groupName : groupName
			}, function(data) {
		 ...
		 $('#year').change(function(event) {
				...
				$.getJSON('getSAPHistoricalProjectionReportNames', {
		 ...
		 $('#reportName').change(function(event) {
			  ...
			  var urll="getSAPHistoricalProjectionHeadings?reportId="+reportId+'&year='+year;
	...
	function excelDownload(){
		...
		form.action = "SAPHistProjectiondownloadExcelData";
		form.method = "POST";
		
		 var facompanygroup=$("select#companyGroup").val();
		 var facompany=$("select#companyName").val();
		 var projInstallDateFrom=$("#datepicker").val();
		 var projInstallDateTo=$("#datepicker1").val();
		 var projCreateDateFrom=$("#datepicker2").val();
		 var projCreateDateTo=$("#datepicker3").val();
		 var year=$("select#year").val();
		 ...
		 var data={facompanygroup:escape(facompanygroup),facompany:escape(facompany),projInstallDateFrom:escape(projInstallDateFrom),projInstallDateTo:escape(projInstallDateTo)
				 ,projCreateDateFrom:escape(projCreateDateFrom),projCreateDateTo:escape(projCreateDateTo),year:escape(year),reportId:escape(reportId),excelDownloadFlow:'true'};
	...
	function search(initload){
		var url='loadSAPProjectionserverSideData?';
		var facompanygroup=$("select#companyGroup").val();	
		var facompany=$("select#companyName").val();		
		var projInstallDateFrom=$("#datepicker").val();
		var projInstallDateTo=$("#datepicker1").val();
...
// 	  alert("Index: " + y[x].index + " is " + y[x].text);
		...
		if (initload == "yes") {
			...
			url=url+'&facompanygroup='+facompanygroup+'&facompany='+facompany+'&projInstallDateFrom='+projInstallDateFrom+'&projInstallDateTo='+projInstallDateTo
			+'&projCreateDateFrom='+projCreateDateFrom+'&projCreateDateTo='+projCreateDateTo+'&year='+year+'&reportId='+reportId;
		}
		//alert(url)
		console.log(url);
				...
				<div class="col-lg-12  col-sm-12 ">
					<div class="accordion" id="Selection">
						<div class="col-lg-6  col-sm-6 " style="margin-left: 40%;">
							<!-- <b style="background-color: white;">FA250 -  Register Report</b> -->
							<b >SAP Historical Income  Projection Report</b>
						</div>
						<!-- <b>FA250 -  Register Report</b> -->
					</div>
					<div class="panel col-lg-12  col-sm-12 " style="max-height: 34%;">
						<div class="row">
							<div id="Selectiontab">
							
								<!-- <div id="RegReport col-lg-12  col-sm-12 " style="max-height: 34%;"> -->
								<div id="RegReport col-lg-12  col-sm-12 " style="width: 1450px;">
									<div class="row" style="margin-left: 1px;">
										...
										<!-- 13sep -->
										<!-- <div class="col-lg-2 col-sm-2 "> Installation From Date</div> -->
										<!-- <div class="col-lg-2 col-sm-2 "> Installation To Date</div> -->
										<!-- <div class="col-lg-2 col-sm-2 "> Creation From Date</div>
										<div class="col-lg-2 col-sm-2 "> Creation To Date</div> -->
...
<!-- 													<option >${item}</option> -->
									...
									<!--<div class="row" style="margin-left: 1px;">-->
										...
										<div>
											<strong style="color: black;"> Installation Start
												Date</strong>
										</div>
										<div class="form-group col-lg-2 col-sm-2  col-md-2 col-xs-2">
									...
									<div class="row">
										...
										<div>
											<strong style="color: black;">&nbsp; Creation
												Start Date</strong>
		...
		<!-- <table id="myDatatable" class="display datatable">
			<thead>
				<tr>
					...
					<th>REMAININGLIFE</th>
					<th>COSTBASIS</th>
					<th>DEPRECIABLEBASIS</th>
					<th>ACCUMULATEDRESERVE</th>
					<th>YTDDEPRECIATION</th>
					<th>NETBOOKVALUE</th>
