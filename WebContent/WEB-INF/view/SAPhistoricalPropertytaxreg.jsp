...
<script>
	$(document).ready(function() {
		...
		console.log(window.location.href)
		 ...
		 $('#companyGroup').change(function(event) {
			...
			$.getJSON('getSAPHistPropertyTaxCompanyNames', {
				groupName : groupName
			}, function(data) {
		 ...
		 $('#year').change(function(event) {
				...
				$.getJSON('getSAPHistPropTaxReportNames', {
		 ...
		 $('#reportName').change(function(event) {
			 ...
			 /*  $('#myDatatable thead').empty();
			  ...
			  var urll="getSAPHistPropertyTaxHeadings?reportId="+reportId+'&year='+year;
	...
	function excelDownload(){
		...
		form.action = "SAPHistPropertyTaxdownloadExcelData";
		form.method = "POST";
	...
	function search(initload){
		var url='loadSAPHistPropertyTaxserverSideData?';
		var facompanygroup=$("select#companyGroup").val();	
		var facompany=$("select#companyName").val();		
		var taxInstallDateFrom=$("#datepicker").val();
		var taxInstallDateTo=$("#datepicker1").val();
				...
				<div class="col-lg-12  col-sm-12 ">
					<div class="accordion" id="Selection">
						<div class="col-lg-6  col-sm-6 " style="margin-left: 40%;">
							...
							<b >SAP Historical Property Tax Asset Register</b>
						</div>
...
<!-- 													<option >${item}</option> -->
									...
									<!--<div class="row" style="margin-left: 1px;">-->
										...
										<a id="searchbutton" href="#" class="btn btn-info btn-md" data-toggle="tooltip" data-placement="right" title="Excute" style="margin-left: -100%;"> <span class="glyphicon glyphicon-play" id="executeBtn" style="font-size: 100%;margin-top: 3%;"></span>
											...
											<div class="form-group col-lg-1 col-sm-1 ">
											<a id="excelDownloadButton" href="#" data-toggle="tooltip" data-placement="right" title="Download To Excel"> <i class="fa fa-file-excel-o" id="excelBtn" style="font-size: 200%;margin-left: -20%;margin-top: -40%;"></i></a>
											</div>
	...
	<!-- <div style="width: 80%"> -->
		...
		<!-- <thead>
			<tr id="header" role="row"><td class="resultsHeader sorting" tabindex="0" aria-controls="tickettable" rowspan="1" colspan="1" aria-label="Corp Book Cost Basis: activate to sort column ascending" style="width: 27px;">Year<br></td><td class="resultsHeader sorting" tabindex="0" aria-controls="tickettable" rowspan="1" colspan="1" aria-label="Corp Book Cost Basis: activate to sort column ascending" style="width: 27px;">Report_Name<br></td><td class="resultsHeader sorting_asc" tabindex="0" aria-controls="tickettable" rowspan="1" colspan="1" aria-sort="ascending" aria-label="Unique Asset#: activate to sort column descending" style="width: 100px;">Entity<br></td><td class="resultsHeader sorting" tabindex="0" aria-controls="tickettable" rowspan="1" colspan="1" aria-label="FA Company: activate to sort column ascending" style="width: 47px;">Unique Asset Number<br></td><td class="resultsHeader sorting" tabindex="0" aria-controls="tickettable" rowspan="1" colspan="1" aria-label="SAP BU: activate to sort column ascending" style="width: 22px;">Asset Number<br></td><td class="resultsHeader sorting" tabindex="0" aria-controls="tickettable" rowspan="1" colspan="1" aria-label="Asset Number - Primary: activate to sort column ascending" style="width: 39px;">Asset Sub Number<br></td><td class="resultsHeader sorting" tabindex="0" aria-controls="tickettable" rowspan="1" colspan="1" aria-label="Asset Component: activate to sort column ascending" style="width: 56px;">Internal Asset Number<br></td><td class="resultsHeader sorting" tabindex="0" aria-controls="tickettable" rowspan="1" colspan="1" aria-label="Internal Asset#: activate to sort column ascending" style="width: 37px;">Legacy Asset Number <br></td><td class="resultsHeader sorting" tabindex="0" aria-controls="tickettable" rowspan="1" colspan="1" aria-label="Asset Description: activate to sort column ascending" style="width: 220px;">Legacy Asset Sub Number <br></td><td class="resultsHeader sorting" tabindex="0" aria-controls="tickettable" rowspan="1" colspan="1" aria-label="Entered Date: activate to sort column ascending" style="width: 38px;">Asset Description<br></td><td class="resultsHeader sorting" tabindex="0" aria-controls="tickettable" rowspan="1" colspan="1" aria-label="Tax Install Date: activate to sort column ascending" style="width: 29px;">Country<br></td><td class="resultsHeader sorting" tabindex="0" aria-controls="tickettable" rowspan="1" colspan="1" aria-label="Tax Asset Life: activate to sort column ascending" style="width: 28px;">State<br></td><td class="resultsHeader sorting" tabindex="0" aria-controls="tickettable" rowspan="1" colspan="1" aria-label="Tax Remaining Life: activate to sort column ascending" style="width: 52px;">County<br></td><td class="resultsHeader sorting" tabindex="0" aria-controls="tickettable" rowspan="1" colspan="1" aria-label="Tax Cost Basis: activate to sort column ascending" style="width: 27px;">City<br></td><td class="resultsHeader sorting" tabindex="0" aria-controls="tickettable" rowspan="1" colspan="1" aria-label="Tax Depreciable Basis: activate to sort column ascending" style="width: 58px;">Street<br></td><td class="resultsHeader sorting" tabindex="0" aria-controls="tickettable" rowspan="1" colspan="1" aria-label="Tax Accumulated Reserve: activate to sort column ascending" style="width: 63px;">ZIP Code<br></td><td class="resultsHeader sorting" tabindex="0" aria-controls="tickettable" rowspan="1" colspan="1" aria-label="Tax YTD Depreciation: activate to sort column ascending" style="width: 61px;">Building Number<br></td><td class="resultsHeader sorting" tabindex="0" aria-controls="tickettable" rowspan="1" colspan="1" aria-label="Tax Net Book Value: activate to sort column ascending" style="width: 28px;">Physical Location Desc<br></td><td class="resultsHeader sorting" tabindex="0" aria-controls="tickettable" rowspan="1" colspan="1" aria-label="Bonus Depreciation: activate to sort column ascending" style="width: 61px;">Entered Date<br></td><td class="resultsHeader sorting" tabindex="0" aria-controls="tickettable" rowspan="1" colspan="1" aria-label="YTD Bonus Depreciation: activate to sort column ascending" style="width: 61px;">Entered Year<br></td><td class="resultsHeader sorting" tabindex="0" aria-controls="tickettable" rowspan="1" colspan="1" aria-label="Elect Out Bonus: activate to sort column ascending" style="width: 31px;">Asset Class<br></td><td class="resultsHeader sorting" tabindex="0" aria-controls="tickettable" rowspan="1" colspan="1" aria-label="Bonus % Flag: activate to sort column ascending" style="width: 31px;">Asset Class Description<br></td><td class="resultsHeader sorting" tabindex="0" aria-controls="tickettable" rowspan="1" colspan="1" aria-label="Bonus %: activate to sort column ascending" style="width: 31px;">GL Category Desc<br></td><td class="resultsHeader sorting" tabindex="0" aria-controls="tickettable" rowspan="1" colspan="1" aria-label="YTD Amt Depr: activate to sort column ascending" style="width: 24px;">Corporate Life<br></td><td class="resultsHeader sorting" tabindex="0" aria-controls="tickettable" rowspan="1" colspan="1" aria-label="ADR Additional Depr: activate to sort column ascending" style="width: 48px;">Install Date<br></td><td class="resultsHeader sorting" tabindex="0" aria-controls="tickettable" rowspan="1" colspan="1" aria-label="ACRS Class: activate to sort column ascending" style="width: 31px;">Install Year<br></td><td class="resultsHeader sorting" tabindex="0" aria-controls="tickettable" rowspan="1" colspan="1" aria-label="Tax Regulation Code: activate to sort column ascending" style="width: 52px;">Corp Book Cost Basis<br></td><td class="resultsHeader sorting" tabindex="0" aria-controls="tickettable" rowspan="1" colspan="1" aria-label="Tax Depr Table: activate to sort column ascending" style="width: 26px;">Corp Book Accumulated Depr<br></td><td class="resultsHeader sorting" tabindex="0" aria-controls="tickettable" rowspan="1" colspan="1" aria-label="Section 1245/1250 Property: activate to sort column ascending" style="width: 52px;">Corp Book NBV<br></td><td class="resultsHeader sorting" tabindex="0" aria-controls="tickettable" rowspan="1" colspan="1" aria-label="Listed Property: activate to sort column ascending" style="width: 42px;">Accounting Year<br></td><td class="resultsHeader sorting" tabindex="0" aria-controls="tickettable" rowspan="1" colspan="1" aria-label="Depr Intangible: activate to sort column ascending" style="width: 48px;">Tax Install Date<br></td><td class="resultsHeader sorting" tabindex="0" aria-controls="tickettable" rowspan="1" colspan="1" aria-label="First Depr Year: activate to sort column ascending" style="width: 24px;">Tax Cost Basis<br></td><td class="resultsHeader sorting" tabindex="0" aria-controls="tickettable" rowspan="1" colspan="1" aria-label="First Depr Year: activate to sort column ascending" style="width: 24px;">Tax NTV<br></td><td class="resultsHeader sorting" tabindex="0" aria-controls="tickettable" rowspan="1" colspan="1" aria-label="Corp Book Cost Basis: activate to sort column ascending" style="width: 27px;">Park Asset Property Tax<br></td><td class="resultsHeader sorting" tabindex="0" aria-controls="tickettable" rowspan="1" colspan="1" aria-label="Corp Internal Asset#: activate to sort column ascending" style="width: 37px;">Invoice Number<br></td><td class="resultsHeader sorting" tabindex="0" aria-controls="tickettable" rowspan="1" colspan="1" aria-label="Tax Amt Table: activate to sort column ascending" style="width: 26px;">Project Number<br></td><td class="resultsHeader sorting" tabindex="0" aria-controls="tickettable" rowspan="1" colspan="1" aria-label="Tax New Or Used: activate to sort column ascending" style="width: 26px;">Purchase Order<br></td><td class="resultsHeader sorting" tabindex="0" aria-controls="tickettable" rowspan="1" colspan="1" aria-label="Tax Auto: activate to sort column ascending" style="width: 23px;">WBSE<br></td><td class="resultsHeader sorting" tabindex="0" aria-controls="tickettable" rowspan="1" colspan="1" aria-label="Tax Leasehold Impr: activate to sort column ascending" style="width: 50px;">Profit Center<br></td><td class="resultsHeader sorting" tabindex="0" aria-controls="tickettable" rowspan="1" colspan="1" aria-label="Tax Depr Method: activate to sort column ascending" style="width: 70px;">Cost Center<br></td><td class="resultsHeader sorting" tabindex="0" aria-controls="tickettable" rowspan="1" colspan="1" aria-label="Tax Depr Convention: activate to sort column ascending" style="width: 55px;">Manufacture<br></td><td class="resultsHeader sorting" tabindex="0" aria-controls="tickettable" rowspan="1" colspan="1" aria-label="Corp Install Date: activate to sort column ascending" style="width: 29px;">Vendor<br></td><td class="resultsHeader sorting" tabindex="0" aria-controls="tickettable" rowspan="1" colspan="1" aria-label="Corp Asset Life: activate to sort column ascending" style="width: 28px;">Attraction ID<br></td><td class="resultsHeader sorting" tabindex="0" aria-controls="tickettable" rowspan="1" colspan="1" aria-label="Corp Book Cost Basis: activate to sort column ascending" style="width: 27px;">Geo Location<br></td><td class="resultsHeader sorting" tabindex="0" aria-controls="tickettable" rowspan="1" colspan="1" aria-label="Corp Book Cost Basis: activate to sort column ascending" style="width: 27px;">Department<br></td><td class="resultsHeader sorting" tabindex="0" aria-controls="tickettable" rowspan="1" colspan="1" aria-label="Corp Book Cost Basis: activate to sort column ascending" style="width: 27px;">Company Name<br></td><td class="resultsHeader sorting" tabindex="0" aria-controls="tickettable" rowspan="1" colspan="1" aria-label="Corp Book Cost Basis: activate to sort column ascending" style="width: 27px;">Serial number<br></td><td class="resultsHeader sorting" tabindex="0" aria-controls="tickettable" rowspan="1" colspan="1" aria-label="Corp Book Cost Basis: activate to sort column ascending" style="width: 27px;">Inventory number<br></td><td class="resultsHeader sorting" tabindex="0" aria-controls="tickettable" rowspan="1" colspan="1" aria-label="Corp Book Cost Basis: activate to sort column ascending" style="width: 27px;">Quantity<br></td><td class="resultsHeader sorting" tabindex="0" aria-controls="tickettable" rowspan="1" colspan="1" aria-label="Corp Book Cost Basis: activate to sort column ascending" style="width: 27px;">Original Asset Number<br></td><td class="resultsHeader sorting" tabindex="0" aria-controls="tickettable" rowspan="1" colspan="1" aria-label="Corp Book Cost Basis: activate to sort column ascending" style="width: 27px;">Type name<br></td><td class="resultsHeader sorting" tabindex="0" aria-controls="tickettable" rowspan="1" colspan="1" aria-label="Corp Book Cost Basis: activate to sort column ascending" style="width: 27px;">Legacy Project No<br></td><td class="resultsHeader sorting" tabindex="0" aria-controls="tickettable" rowspan="1" colspan="1" aria-label="Corp Book Cost Basis: activate to sort column ascending" style="width: 27px;">Tracking Number<br></td>
			</tr>
		</thead>
		<tbody>
