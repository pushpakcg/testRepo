...
<script>
	...
	$(document).ready(function() {
		...
		$("#excelDownloadButton").click(function(){
			...
			AssetRegisterSummaryExcelDownload(); 
		 ...
		 $('#companyGroup').change(function(event) {
			...
			$.post('getAssetRegisterSummaryReportCompanyNames', {
				groupName : groupName
...
// 		 function headings()
// 		 {
// 			 var url="getFederalTaxSummaryReportHeadings";
...
// 		 }
	...
	function AssetRegisterSummaryExcelDownload(){
		
		var form = document.createElement("form");
		form.action = "getAssetRegisterSummaryReportDownloadExcelData";
		form.method = "POST";
		
		var sumgroup=$("select#companyGroup").val();
		var sumcompany=$("select#companyName").val();
...
// 		var adstaxassetCreateDateTo=$("#datepicker3").val();
		...
		var data={sumgroup:escape(sumgroup),sumcompany:escape(sumcompany),AssetRegisterSummaryExcelDownload:'true'};
	...
	function search(initload){
		var url='getAssetRegisterSummaryReportServerSideData?';
...
// 		var adstaxassetCreateDateTo=$("#datepicker3").val();
		...
		if (initload == "yes") {
			url=url+'&sumcompany=dummycompany123456';
		}else{
			url=url+'&sumgroup='+sumgroup+'&sumcompany='+sumcompany;
				...
				<div class="col-lg-12  col-sm-12 ">
					<div class="accordion" id="Selection">
						<div class="col-lg-6  col-sm-6 " style="margin-left: 40%;">
							...
							<b >Asset Register Summary Report</b>
						</div>
...
<!-- 										</div> -->
	...
	<div class="tableDiv" style="margin-top: 4px;margin-left:5px;margin-right:5px;overflow-x:scroll">
		...
		<thead>
			...
			<td>Company Code<br></td>
			<td>Company Name<br></td>
			<td>Number of Assets<br></td>
			<td>Total Tax APC<br></td>
			<td>Total Depreciable Basis<br></td>
			<td>Total Year to Date Depreciation<br></td>
			<td>Total Tax NBV<br></td>
			<td>Total Bonus Depreciation<br></td>
			<td>Total Corp Book APC<br></td>
			<td>Total Corp Book Accumulated Depreciation<br></td>
		    <td>Total Corp NBV<br></td>
		    </tr>
			</thead>
			<tbody>
