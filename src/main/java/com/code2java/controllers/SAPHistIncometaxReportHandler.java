...
public class SAPHistIncometaxReportHandler {
		...
		for (List<String> list : resultDataList) {
			...
			for (String entry : list) {
				...
				if (StringUtils.isNotBlank(entry)
						&& (cellNum == 16 || cellNum == 17 || cellNum == 18 || cellNum == 19 || cellNum == 20
								|| cellNum == 21 || cellNum == 22 || cellNum == 36 || cellNum == 37 || cellNum == 38)) {
