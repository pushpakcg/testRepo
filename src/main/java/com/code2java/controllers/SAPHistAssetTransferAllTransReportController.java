...
import com.code2java.service.SAPHistAssetTransferAllTransService;
import com.google.gson.Gson;



@Controller
public class SAPHistAssetTransferAllTransReportController{

	
	
	@Autowired
	private SAPHistAssetTransferAllTransService sapHistAssetTransferAllTransService;
	
	
	@RequestMapping(value = "/SAPHistAssetTransferAllTrans")
...
//		model.addAttribute("instanceMap", getSAPHistoricalAssetTransferInstances());
		...
		return "SAPHistAssetTransferAllTransReport";
	}	
		
		
		//ServerSide Data	
		@ResponseBody
		@RequestMapping("/loadSAPHistAssetTransferAllTransserverSideData")
		public String loAssetTransferAPHistAssetTransferServerSideData(HttpServletResponse response, HttpServletRequest request)
		{
			...
			String jsonResponse = sapHistAssetTransferAllTransService.getSAPHistAssetTransferAllTransDataTableResponse(request);
		...
		@RequestMapping("/SAPHistAssetTransferAllTransdownloadExcelData")
		public void downloadExcelData(HttpServletResponse response, HttpServletRequest request) throws IOException {
			...
			SXSSFWorkbook workBook = sapHistAssetTransferAllTransService.getSAPHistAssetTransferAllTransExcelData(request);			
		...
		public Map<String,String> getSAPHistoricalAssetTransferCompanyGroups(){
			...
			List<String[]> list=sapHistAssetTransferAllTransService.getSAPHistAssetTransferAllTransCompanyGroups();
			for(String[] s:list) {
...
//		}
		...
		public Map<String,String> getSAPHistoricalAssetTransferYears(){
			...
			List<String[]> list=sapHistAssetTransferAllTransService.getSAPHistAssetTransferAllTransYears();
			for(String[] s:list) {
				yearMap.put(s[0], s[0]);
			}
			return yearMap;
		...
		@RequestMapping(value = "getSAPHistoricalAssetTransferAllTransReportNames", method = RequestMethod.GET)
		public @ResponseBody String getSAPHistoricalAssetTransferReportNames(
			...
			List<String[]> list=sapHistAssetTransferAllTransService.getSAPHistAssetTransferAllTransReportNames(reportList);
...
//				reportNamesMap.put(s[0], s[0]+" - "+s[1]);
		...
		@RequestMapping(value = "getSAPHistoricalAssetTransferAllTransCompanyNames", method = RequestMethod.GET)
		public @ResponseBody String getSAPHistoricalAssetTransferCompanyNames(
			...
			List<String[]> list=sapHistAssetTransferAllTransService.getSAPHistAssetTransferAllTransCompanyNames(groupName);					
			for(String[] s:list) {
		...
		@RequestMapping("/getSapHistAssetTransferAllTransHeadings")
		public @ResponseBody String getHeadingNames(HttpServletRequest request)
		{
			List<String> headings=new ArrayList<>();
			List<String[]> headingList=sapHistAssetTransferAllTransService.getTableHeadings(request);
